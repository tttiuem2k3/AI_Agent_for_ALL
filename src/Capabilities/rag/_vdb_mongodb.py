    ...
    def get_client(self) -> "AsyncMongoClient":
        ...
        if self._client is None:
            try:
                ...
                raise ImportError(
                    "MongoDBVectorStore requires pymongo. Install with "
                    "asoft-ai-services[vdb-mongodb].",
                ) from exc
