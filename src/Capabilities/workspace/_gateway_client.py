...
class GatewayMCPTool(ToolBase):
    ...
    Mirrors :class:`Capabilities.tool.MCPTool` field-by-field so the toolkit
    ...
    def __init__(
        ...
        :class:`Capabilities.tool.MCPTool` (``name``, ``description``,
    ...
    async def check_permissions(
        ...
        **_kwargs: Any,
        ...
        :class:`Capabilities.tool.MCPTool.check_permissions` so toolkit
