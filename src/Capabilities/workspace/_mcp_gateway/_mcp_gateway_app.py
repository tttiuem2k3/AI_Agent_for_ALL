...
def _build_app(state: _State) -> FastAPI:
    ...
    app = FastAPI(title="ASOFT-workspace-mcp-gateway")
...
def main() -> None:
    ...
    ``python -m Capabilities.workspace._mcp_gateway``.
    """
