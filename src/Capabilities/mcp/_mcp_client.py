# -*- coding: utf-8 -*-
"""Unified MCP client implementation for ASOFT AI Services."""
import re
...
if TYPE_CHECKING:
    from Capabilities.tool import MCPTool, ToolBase
else:
    MCPTool = Any
    ToolBase = Any
...
class MCPClient(BaseModel):
    """The unified MCP client in ASOFT AI Services.
    ...
    async def get_tool(
        ...
        from Capabilities.tool import MCPTool
