...
class MCPTool(ToolBase):
    ...
    ASOFT AI Services's ToolChunk format.
    """
    ...
    async def call(
        ...
        **kwargs: Any,
        ...
        # Convert MCP result to ASOFT AI Services blocks
        return ToolChunk(
    ...
    def _convert_mcp_content_to_blocks(
        ...
        """Convert MCP content to ASOFT AI Services blocks.
        ...
        Returns:
            `list[TextBlock | DataBlock]`: Converted ASOFT AI Services blocks.
        """
