...
class AGUIProtocolMiddleware(ProtocolMiddlewareBase):
    """The middleware that converts the ASOFT AI Services events into AGUI
    protocol."""
    ...
    def _convert_to_protocol(self, event: AgentEvent) -> dict:
        """Convert the ASOFT AI Services events into AGUI protocol."""
    ...
    def _to_agui_event(  # noqa: C901
        ...
        """Convert an ASOFT AI Services event to an AGUI event."""
