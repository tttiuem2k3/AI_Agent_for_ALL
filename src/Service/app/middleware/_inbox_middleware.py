...
Producers push :class:`~Runtime.message.HintBlock` payloads into
the per-session inbox via :class:`~Service.app._message_bus.MessageBus`.
...
from Runtime.event import HintBlockEvent
...
class InboxMiddleware(MiddlewareBase):  # pylint: disable=abstract-method
    ...
    :class:`~Runtime.message.HintBlock`. The middleware
    ...
    Args:
        message_bus (`MessageBus`):
            The app message bus to read from.
