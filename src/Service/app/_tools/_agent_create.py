...
from Runtime.message import HintBlock, TextBlock, ToolResultState
from Capabilities.permission import PermissionContext
from Runtime.state import AgentState
from Capabilities.tool import ToolChunk, ParamsBase
...
# ``type="default"`` via :func:`~Service.app.create_app`.
#
    ...
    def __init__(
        ...
        Args:
            storage (`StorageBase`):
                app storage backend.
            message_bus (`MessageBus`):
                app message bus for inter-session delivery.
            user_id (`str`):
