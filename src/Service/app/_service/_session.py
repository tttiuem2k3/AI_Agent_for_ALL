...
:class:`~Service.app._tools.TeamDelete` /
:class:`~Service.app._manager._scheduler._tools.ScheduleDelete`
tools all share.
...
class SessionService:
    ...
    async def cancel_session_run(
        ...
        *,
        ...
        :class:`~Service.app._manager.CancelDispatcher` reacts to the
