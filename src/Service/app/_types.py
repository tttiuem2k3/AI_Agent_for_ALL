# -*- coding: utf-8 -*-
"""Shared type aliases for the ASOFT app layer."""
...
#  Async factory signature: ``(user_id, agent_id, session_id)`` →
#  awaitable of :class:`~Capabilities.tool.ToolBase` instances.
...
class EventProjector(Protocol):
    ...
    errors, …). :class:`~Service.app._service.ChatService` calls
