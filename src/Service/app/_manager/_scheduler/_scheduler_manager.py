...
from Capabilities.permission import PermissionContext
...
class SchedulerManager:
    ...
    The manager owns both the in-middleware APScheduler instance and the trigger
    ...
    inbox and enqueue a wakeup, so that the app-wide
    ...
    def __init__(
        ...
        Args:
            storage (`StorageBase`):
                ...
                creation.
            message_bus (`MessageBus`):
                The app message bus. Each scheduled fire pushes
    ...
    def _build_trigger(
        ...
        3. Calls :class:`~Service.app._service._chat.ChatService` and
