...
class SummarySchema(BaseModel):
    """The compressed middleware model, used to generate summary of old memories"""
...
class ContextConfig(BaseModel):
    """The context related configuration in ASOFT AI Services"""
    ...
    attach to the end of the current middleware."""
