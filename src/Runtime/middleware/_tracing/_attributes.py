# -*- coding: utf-8 -*-
"""The tracing types class in ASOFT."""
...
class SpanAttributes:
    ...
    ASOFT_CACHE_INPUT_TOKENS = "ASOFT.usage.cache_input_tokens"
    """The number of input tokens read from prompt cache."""

    ASOFT_CACHE_CREATION_INPUT_TOKENS = (
        "ASOFT.usage.cache_creation_input_tokens"
    )
    """The number of input tokens used to create prompt cache."""

    ASOFT_REPLY_ID = "ASOFT.agent.reply_id"
    ...
    ASOFT_HITL_PENDING_TOOLS = "ASOFT.agent.hitl_pending_tools"
    ...
    ASOFT_EXTERNAL_EXECUTION_PENDING_TOOLS = (
    ...
    ASOFT_INCOMING_EVENT_TYPE = "ASOFT.agent.incoming_event_type"
    ...
    ASOFT_IS_EXTERNAL_EXECUTION = "ASOFT.agent.is_external_execution"
