# -*- coding: utf-8 -*-
"""The common utilities for ASOFT library."""
import asyncio
import base64
import functools
import inspect
...
from Common.exception import ToolJSONDecodeError
...
def set_id_factory(factory: Callable[[], str]) -> None:
    """Override the global ID factory used by all ASOFT AI Services entities.
    ...
    Example:
        >>> from Common._utils import set_id_factory
