...
if TYPE_CHECKING:
    ...
    from Providers.modelLLM.model import ChatModelBase, ModelCard
    from Providers.modelBSN.tts import TTSModelBase
    from Providers.modelBSN.tts._tts_model_card import TTSModelCard
