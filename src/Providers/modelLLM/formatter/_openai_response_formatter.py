        ...
        while i < len(msgs):
            ...
            for block in msg.get_content_blocks():
                if isinstance(block, TextBlock):
                    # Responses API distinguishes prior model output from
                    # user/developer input. This matters only from turn two:
                    # the first request has no assistant history to format.
                    text_type = (
                        "output_text"
