...
class EmbeddingModelCard(BaseModel):
    ...
    Mirrors :class:`~ASOFT.model.ModelCard` but tailored for
    ...
    The output type ``app/x-embedding`` indicates that the
    ...
    output_types: list[str] = Field(
        default=["app/x-embedding"],
        description="Supported output media types.",
    )
    """Output types. ``app/x-embedding`` for vector output."""
    ...
    def from_yaml(
        ...
        approach used by :meth:`~ASOFT.model.ModelCard.from_yaml`.
