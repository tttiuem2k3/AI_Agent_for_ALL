...
additionally accept :class:`~Runtime.message.DataBlock`.
...
from Runtime.message import DataBlock, Base64Source, URLSource
...
class DashScopeEmbeddingModel(EmbeddingModelBase[str | DataBlock]):
    ...
    def __init__(
        ...
        Args:
            credential (`CredentialBase`):
                A :class:`~Providers.credential.DashScopeCredential`
        ...
        **kwargs: Any,
        ...
        Args:
            inputs (`list[str | DataBlock]`):
                ...
                :class:`~Runtime.message.DataBlock`.
            **kwargs:
                Forwarded to the DashScope API.
    ...
    def _format_data_block(block: DataBlock) -> dict[str, str]:
        """Convert a :class:`~Runtime.message.DataBlock` to the dict
