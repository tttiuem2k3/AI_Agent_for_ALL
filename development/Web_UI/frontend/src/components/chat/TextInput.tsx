import type { ContentBlock, TextBlock } from '@/protocol/message';
...
interface TextInputProps {
	 ...
	 *   - PDF:       "app/pdf"
	 *   - Word:      ".doc,.docx,app/msword,app/vnd.openxmlformats-officedocument.wordprocessingml.document"
	 *   - Excel:     ".xls,.xlsx,app/vnd.ms-excel,app/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
	 *
