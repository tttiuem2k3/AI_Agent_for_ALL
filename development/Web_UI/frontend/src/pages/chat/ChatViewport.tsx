import type { PermissionContext } from '@/protocol/permission';
import type { TaskContext } from '@/protocol/state';
								...
								<ChatContent
									...
									allowedInputTypes={(
										...
										(t) =>
											...
											t === 'app/pdf' ||
											t.startsWith('app/vnd.') ||
											t.startsWith('app/msword') ||
											t.startsWith('app/vnd.openxmlformats'),
									)}
									fileProcessor={async (file) => {
										...
										return {
											...
											source: {
												...
												media_type: file.type || 'app/octet-stream',
												data: base64,
											},
											name: file.name,
										};
