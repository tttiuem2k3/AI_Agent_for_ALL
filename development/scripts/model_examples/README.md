...
This directory contains example scripts for the major LLM providers supported by ASOFT AI Services, together with a unified test runner `run_tests.py`.
These scripts are designed to verify that ASOFT AI Services's chat model components function correctly across various input scenarios.
...
```
development/scripts/model_examples/
...
```bash
python development/scripts/model_examples/run_tests.py --list
```
...
```bash
python development/scripts/model_examples/run_tests.py
```
...
python development/scripts/model_examples/run_tests.py --providers openai_chat,anthropic

# Only run a specific test type (across all available providers)
python development/scripts/model_examples/run_tests.py --tests call

# Combine: run call + multiagent tests for dashscope and deepseek
python development/scripts/model_examples/run_tests.py -p dashscope,deepseek -t call,multiagent

# Only run multimodal tests
python development/scripts/model_examples/run_tests.py --tests multimodal,multiagent_multimodal

# Increase per-script timeout
python development/scripts/model_examples/run_tests.py --timeout 180
...
```bash
python development/scripts/model_examples/openai_chat_call.py
python development/scripts/model_examples/dashscope_multiagent.py
python development/scripts/model_examples/ollama_multimodal.py
```
