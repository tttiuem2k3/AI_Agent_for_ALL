# -*- coding: utf-8 -*-
"""Unified test runner for ASOFT AI Services model scripts.
...
Usage service:
    ...
    python development/scripts/model_examples/run_tests.py --providers openai_chat,
    anthropic,gemini

    # Run only specific test types
    python development/scripts/model_examples/run_tests.py --tests call,multiagent
    ...
    python development/scripts/model_examples/run_tests.py --providers ollama

    # Set a per-test timeout (seconds, default 120)
    python development/scripts/model_examples/run_tests.py --timeout 60

    # Stream each script's output to the terminal (default: suppressed,
    shown only on failure)
    python development/scripts/model_examples/run_tests.py --verbose
"""
import argparse
import os
import subprocess
...
def main() -> int:
    ...
    print_header(
        f"ASOFT AI Services Model Tests  |  providers: {len(providers)}  |  test "
