...
from Service.app._manager._background_task_manager import ToolStop
from Service.app import MessageBus
from Runtime.message import ToolResultState


class _FakeBus(MessageBus):
    """In-middleware bus with just enough behaviour for the dispatcher.
    ...
    # Mode F — registry (in-middleware dict)
