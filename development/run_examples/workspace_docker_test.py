...
from Capabilities.workspace import DockerWorkspace
from Capabilities.workspace._docker._make_dockerfile import (
...
class TestDockerWorkspaceLifecycle(IsolatedAsyncioTestCase):
    ...
    async def test_list_tools_builtin(self) -> None:
        ...
        from Capabilities.tool._builtin import (
            Bash,
            Edit,
            Glob,
            Grep,
        ...
        from Capabilities.workspace._docker._docker_backend import DockerBackend
