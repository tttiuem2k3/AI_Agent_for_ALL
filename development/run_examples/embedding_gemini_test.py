...
from Providers.modelBSN.embedding import (
    GeminiEmbeddingModel,
    EmbeddingResponse,
    EmbeddingUsage,
)
from Runtime.message import DataBlock, Base64Source
...
class GeminiListModelsTest(IsolatedAsyncioTestCase):
    ...
    async def test_multimodal_model_card(self) -> None:
        ...
        self.assertIn("app/pdf", card.input_types)
...
class GeminiMultimodalCallTest(IsolatedAsyncioTestCase):
    ...
    def _make_multimodal_model(self) -> GeminiEmbeddingModel:
        ...
        model.embedding_cache = None
        from Providers.modelBSN.embedding._gemini._model import _MultimodalLimits
