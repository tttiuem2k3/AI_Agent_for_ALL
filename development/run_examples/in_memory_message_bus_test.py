...
pure-Python in-middleware backend, plus the domain helpers inherited from
...
from Service.app import InMemoryMessageBus
...
class TestDomainHelpers(IsolatedAsyncioTestCase):
    ...
    async def test_bg_task_round_trip(self) -> None:
        ...
        work on the in-middleware backend."""
        sid = "s-bg"
